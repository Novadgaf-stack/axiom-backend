"""
NEXUS-7 Research V30 — Zero-Stub Candle Traversal Resolver Module
...
stop-distance position sizing, portfolio daily circuit breaker, asset correlation limits,
and execution stress (missed signals / execution delays).
"""
...
def resolve_zero_stub_trades(
    df: pd.DataFrame,
    risk_fraction: float = 0.0050,      # 0.50% default account risk
    ...
    while i < n - 1:
        ...
        if signal != 0 and not circuit_breaker_tripped:
            # Simulate missed signals for execution stress testing
            ...
            # Position sizing calculated from stop distance & correlation penalty
            ...
            # Bounded by max_position_equity_pct cap
            ...
            for j in range(entry_bar_idx, min(entry_bar_idx + 100, n)):
                ...
                if direction == 1: # LONG
                    ...
                    # Conservative same-candle SL + TP collision resolution -> LOSS
