"""
NEXUS-7 Research V29 — Multi-Asset Data Pipeline Module
...
and asset-to-asset return correlation matrix computation.
"""
...
def generate_synthetic_asset_data(
    ...
    # Generate log returns with occasional regime jumps
    raw_returns = rng.normal(0, vol_scale * asset_beta, size=num_bars)
    
    # Add trending regimes (bull / bear waves)
    regime_length = 300
    for i in range(0, num_bars, regime_length):
        regime_drift = rng.uniform(-0.0003, 0.0003)
