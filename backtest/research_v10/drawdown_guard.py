"""
NEXUS-7 — HARD PORTFOLIO DRAWDOWN CIRCUIT BREAKER WITH AUTO-RECOVERY (RESEARCH V10 / V12)
Enforces a hard 15.0% peak-to-trough portfolio drawdown circuit breaker with daily reset & hysteresis recovery.
"""
...
class PortfolioDrawdownGuard:
    ...
    def __init__(
        ...
        recovery_buffer_pct: float = 5.0,  # Unlocks when equity recovers to within 5% of peak
    ...
    def is_circuit_breaker_triggered(self, current_equity: float) -> bool:
        ...
        if self._circuit_breaker_active:
            # Check for hysteresis recovery: unlock if equity recovers to within recovery_buffer_pct of peak
