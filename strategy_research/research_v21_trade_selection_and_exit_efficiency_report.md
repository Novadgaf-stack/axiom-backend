...
**Report Generated:** 2026-08-14 17:20:22 UTC  
**Execution Duration:** 2.12s  
...
| :--- | :--- | :--- | :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :--- |
| **SOL/USDT** | `1_Train_70pct` | `1_V20_Baseline` | `1H_Only` | `Fixed_ATR_3.5x` | 0.30% | 16 | 56.2% | **0.73** | +$-23.71 | +$-1.48 | **-0.01R** | 0.7% | **[0.16, 2.40]** | **FAIL (NO ROBUST EDGE)** |
| **SOL/USDT** | `1_Train_70pct` | `2_MTF_VolumeSurge_Gating` | `4H_EMA_VolumeSurge` | `Fixed_ATR_3.5x` | 0.30% | 16 | 56.2% | **0.73** | +$-23.71 | +$-1.48 | **-0.01R** | 0.7% | **[0.16, 2.40]** | **FAIL (NO ROBUST EDGE)** |
| **SOL/USDT** | `1_Train_70pct` | `3_Full_V21_Extended_Trail` | `4H_EMA_VolumeSurge` | `Extended_ATR_Trail_4.0x` | 0.30% | 16 | 56.2% | **0.73** | +$-23.71 | +$-1.48 | **-0.01R** | 0.7% | **[0.16, 2.40]** | **FAIL (NO ROBUST EDGE)** |
| **SOL/USDT** | `1_Train_70pct` | `4_High_Friction_Sensitivity` | `4H_EMA_VolumeSurge` | `Extended_ATR_Trail_4.0x` | 0.45% | 16 | 50.0% | **0.52** | +$-47.65 | +$-2.98 | **-0.02R** | 0.9% | **[0.08, 1.78]** | **FAIL (NO ROBUST EDGE)** |
| **SOL/USDT** | `2_Validation_15pct` | `1_V20_Baseline` | `1H_Only` | `Fixed_ATR_3.5x` | 0.30% | 4 | 50.0% | **0.32** | +$-15.40 | +$-3.85 | **-0.02R** | 0.2% | **[0.00, 0.00]** | **FAIL (NO ROBUST EDGE)** |
| **SOL/USDT** | `2_Validation_15pct` | `2_MTF_VolumeSurge_Gating` | `4H_EMA_VolumeSurge` | `Fixed_ATR_3.5x` | 0.30% | 4 | 50.0% | **0.32** | +$-15.40 | +$-3.85 | **-0.02R** | 0.2% | **[0.00, 0.00]** | **FAIL (NO ROBUST EDGE)** |
| **SOL/USDT** | `2_Validation_15pct` | `3_Full_V21_Extended_Trail` | `4H_EMA_VolumeSurge` | `Extended_ATR_Trail_4.0x` | 0.30% | 4 | 50.0% | **0.32** | +$-15.40 | +$-3.85 | **-0.02R** | 0.2% | **[0.00, 0.00]** | **FAIL (NO ROBUST EDGE)** |
| **SOL/USDT** | `2_Validation_15pct` | `4_High_Friction_Sensitivity` | `4H_EMA_VolumeSurge` | `Extended_ATR_Trail_4.0x` | 0.45% | 4 | 25.0% | **0.17** | +$-21.39 | +$-5.35 | **-0.03R** | 0.2% | **[0.00, 0.00]** | **FAIL (NO ROBUST EDGE)** |
| **SOL/USDT** | `3_Untouched_Test_15pct` | `1_V20_Baseline` | `1H_Only` | `Fixed_ATR_3.5x` | 0.30% | 3 | 33.3% | **0.11** | +$-8.73 | +$-2.91 | **-0.01R** | 0.1% | **[0.00, 0.00]** | **FAIL (NO ROBUST EDGE)** |
| **SOL/USDT** | `3_Untouched_Test_15pct` | `2_MTF_VolumeSurge_Gating` | `4H_EMA_VolumeSurge` | `Fixed_ATR_3.5x` | 0.30% | 3 | 33.3% | **0.11** | +$-8.73 | +$-2.91 | **-0.01R** | 0.1% | **[0.00, 0.00]** | **FAIL (NO ROBUST EDGE)** |
| **SOL/USDT** | `3_Untouched_Test_15pct` | `3_Full_V21_Extended_Trail` | `4H_EMA_VolumeSurge` | `Extended_ATR_Trail_4.0x` | 0.30% | 3 | 33.3% | **0.11** | +$-8.73 | +$-2.91 | **-0.01R** | 0.1% | **[0.00, 0.00]** | **FAIL (NO ROBUST EDGE)** |
| **SOL/USDT** | `3_Untouched_Test_15pct` | `4_High_Friction_Sensitivity` | `4H_EMA_VolumeSurge` | `Extended_ATR_Trail_4.0x` | 0.45% | 3 | 0.0% | **0.00** | +$-13.23 | +$-4.41 | **-0.02R** | 0.1% | **[0.00, 0.00]** | **FAIL (NO ROBUST EDGE)** |
...
| **BTC/USDT** | `3_Untouched_Test_15pct` | `1_V20_Baseline` | `1H_Only` | `Fixed_ATR_3.5x` | 0.30% | 1 | 0.0% | **0.00** | +$-7.98 | +$-7.98 | **-0.05R** | 0.1% | **[0.00, 0.00]** | **FAIL (NO ROBUST EDGE)** |
| **BTC/USDT** | `3_Untouched_Test_15pct` | `2_MTF_VolumeSurge_Gating` | `4H_EMA_VolumeSurge` | `Fixed_ATR_3.5x` | 0.30% | 1 | 0.0% | **0.00** | +$-7.98 | +$-7.98 | **-0.05R** | 0.1% | **[0.00, 0.00]** | **FAIL (NO ROBUST EDGE)** |
| **BTC/USDT** | `3_Untouched_Test_15pct` | `3_Full_V21_Extended_Trail` | `4H_EMA_VolumeSurge` | `Extended_ATR_Trail_4.0x` | 0.30% | 1 | 0.0% | **0.00** | +$-7.98 | +$-7.98 | **-0.05R** | 0.1% | **[0.00, 0.00]** | **FAIL (NO ROBUST EDGE)** |
| **BTC/USDT** | `3_Untouched_Test_15pct` | `4_High_Friction_Sensitivity` | `4H_EMA_VolumeSurge` | `Extended_ATR_Trail_4.0x` | 0.45% | 1 | 0.0% | **0.00** | +$-9.48 | +$-9.48 | **-0.06R** | 0.1% | **[0.00, 0.00]** | **FAIL (NO ROBUST EDGE)** |
