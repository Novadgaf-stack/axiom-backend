...
**Report Generated:** 2026-08-15 08:29:53 UTC  
...
| :--- | :--- | :--- | :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :--- |
| **SOL/USDT** | `1_Train_70pct` | `1_V20_Baseline` | `1H_Only` | `Fixed_ATR_3.5x` | 0.30% | 15 | 60.0% | **0.83** | +$-13.66 | +$-0.91 | **-0.01R** | 0.7% | **[0.16, 3.61]** | **FAIL (NO ROBUST EDGE)** |
| **SOL/USDT** | `1_Train_70pct` | `2_MTF_VolumeSurge_Gating` | `4H_EMA_VolumeSurge` | `Fixed_ATR_3.5x` | 0.30% | 15 | 60.0% | **0.83** | +$-13.66 | +$-0.91 | **-0.01R** | 0.7% | **[0.16, 3.61]** | **FAIL (NO ROBUST EDGE)** |
| **SOL/USDT** | `1_Train_70pct` | `3_Full_V21_Extended_Trail` | `4H_EMA_VolumeSurge` | `Extended_ATR_Trail_4.0x` | 0.30% | 15 | 60.0% | **0.83** | +$-13.66 | +$-0.91 | **-0.01R** | 0.7% | **[0.16, 3.61]** | **FAIL (NO ROBUST EDGE)** |
| **SOL/USDT** | `1_Train_70pct` | `4_High_Friction_Sensitivity` | `4H_EMA_VolumeSurge` | `Extended_ATR_Trail_4.0x` | 0.45% | 15 | 46.7% | **0.61** | +$-36.13 | +$-2.41 | **-0.01R** | 0.9% | **[0.07, 2.87]** | **FAIL (NO ROBUST EDGE)** |
...
| **BTC/USDT** | `2_Validation_15pct` | `1_V20_Baseline` | `1H_Only` | `Fixed_ATR_3.5x` | 0.30% | 5 | 40.0% | **0.05** | +$-19.23 | +$-3.85 | **-0.03R** | 0.2% | **[0.00, 0.00]** | **FAIL (NO ROBUST EDGE)** |
| **BTC/USDT** | `2_Validation_15pct` | `2_MTF_VolumeSurge_Gating` | `4H_EMA_VolumeSurge` | `Fixed_ATR_3.5x` | 0.30% | 5 | 40.0% | **0.05** | +$-19.23 | +$-3.85 | **-0.03R** | 0.2% | **[0.00, 0.00]** | **FAIL (NO ROBUST EDGE)** |
| **BTC/USDT** | `2_Validation_15pct` | `3_Full_V21_Extended_Trail` | `4H_EMA_VolumeSurge` | `Extended_ATR_Trail_4.0x` | 0.30% | 5 | 40.0% | **0.05** | +$-19.23 | +$-3.85 | **-0.03R** | 0.2% | **[0.00, 0.00]** | **FAIL (NO ROBUST EDGE)** |
| **BTC/USDT** | `2_Validation_15pct` | `4_High_Friction_Sensitivity` | `4H_EMA_VolumeSurge` | `Extended_ATR_Trail_4.0x` | 0.45% | 5 | 0.0% | **0.00** | +$-26.72 | +$-5.34 | **-0.04R** | 0.3% | **[0.00, 0.00]** | **FAIL (NO ROBUST EDGE)** |
