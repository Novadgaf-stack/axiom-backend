...
| **BTC/USDT** | `3_Untouched_Test_15pct` | `1_Baseline_Untouched_Test` | 2 | 0.0% | **0.00** | +$-8.11 | +$-4.06 | **-0.03R** | 0.1% | **[0.00, 0.00]** | **FAIL (NO ROBUST EDGE)** |
| **BTC/USDT** | `3_Untouched_Test_15pct` | `2_High_Confidence_Refinement` | 2 | 0.0% | **0.00** | +$-8.11 | +$-4.06 | **-0.03R** | 0.1% | **[0.00, 0.00]** | **FAIL (NO ROBUST EDGE)** |
| **BTC/USDT** | `3_Untouched_Test_15pct` | `3_Tiny_Risk_Sizing_0.5pct` | 2 | 0.0% | **0.00** | +$-8.11 | +$-4.06 | **-0.03R** | 0.1% | **[0.00, 0.00]** | **FAIL (NO ROBUST EDGE)** |
| **BTC/USDT** | `3_Untouched_Test_15pct` | `4_Extended_ATR_Trail_4.5x` | 2 | 0.0% | **0.00** | +$-8.11 | +$-4.06 | **-0.03R** | 0.1% | **[0.00, 0.00]** | **FAIL (NO ROBUST EDGE)** |
