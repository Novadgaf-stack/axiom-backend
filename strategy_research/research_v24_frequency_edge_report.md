...
**Report Generated:** 2026-08-14 16:14:23 UTC  
**Execution Duration:** 181.40s  
...
| **6** | `V23_Baseline_SOL_BTC_1h` | `Baseline` | `SOL/USDT,BTC/USDT` | `60m` | **0.33** | 3 | 33.3% | **0.12** | +$-8.61 | +$-2.87 | **-0.01R** | 0.1% | **[0.00, 0.00]** | **SAFE BASELINE** |
| **7** | `PhaseB_Universe9_1h_Strict` | `PhaseB_Universe` | `SOL/USDT,BTC/USDT,ETH/USDT (+6)` | `60m` | **0.33** | 3 | 33.3% | **0.12** | +$-8.61 | +$-2.87 | **-0.01R** | 0.1% | **[0.00, 0.00]** | **FAIL (SUB-TARGET OR NO EDGE)** |
...
4. **Safe Baseline Candidate:** `V23_Baseline_SOL_BTC_1h` (0.33 trades/day, Net PF 0.12, Bootstrap CI [0.00, 0.00]).
